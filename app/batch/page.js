...
export default function BatchScores() {
  ...
  const processTickerInput = (input) => {
    return input
      ...
      .slice(0, 20); // Limit to 20 tickers
  };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    ...
                    <div className="text-sm text-white/60 flex items-center">
                      {processTickerInput(tickerInput).length}/20 tickers
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  disabled={processTickerInput(tickerInput).length === 0 || loading}
                ...
                >
                  {loading ? (
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <span>Analyzing {processTickerInput(tickerInput).length} tickers...</span>
                    </div>
                  ) : (
                    <div className="flex items-center justify-center gap-3">
                      <BarChart3 className="w-5 h-5" />
                      <span>Analyze {processTickerInput(tickerInput).length} Tickers</span>
                    </div>
                  )}
                </button>
              </div>
